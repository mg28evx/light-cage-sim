...
\title{\textbf{Simulador \code{light-cage-sim}: física, sensibilidad y calibración}\\[4pt]
\large Documento maestro --- trazado de rayos Monte Carlo, análisis de sensibilidad y estimación bayesiana de parámetros bio-ópticos}
\author{EVOLUX}
\date{\today}
...
cada submodelo. La segunda parte del documento integra el \emph{marco de estimación} construido sobre el simulador: el análisis de sensibilidad de las fuentes de incertidumbre (método de Morris), la calibración bayesiana de los parámetros bio-ópticos frente a mediciones (marginalización de \emph{nuisances}, muestreo de importancia múltiple y selección por evidencia), y su aplicación al sitio Punta Iglesia.
\end{abstract}
...
\subsection{Modo RAS bloqueado}

El simulador expone un modo \code{scattering\,$\to$\,ras\_bardsnes} que está
deliberadamente deshabilitado: la invocación lanza una excepción. El trabajo de
Bårdsnes (2020) respalda cualitativamente la influencia de la carga orgánica y las
micropartículas sobre la luz en sistemas de recirculación (RAS), pero no entrega
coeficientes universales transferibles. El modo permanece bloqueado hasta disponer
de una calibración propia que relacione la carga orgánica con $c(\lambda)$,
$K_d(\lambda)$ o la transmitancia espectral.

\src{Bloqueo explícito: \code{simulation\_engine.py}, líneas 318--322.}
...
\begin{itemize}[itemsep=3pt]
  ...
  exactas de la RTE.
  \item \textbf{Modo RAS no calibrado.} El submodelo \code{ras\_bardsnes} está
  bloqueado por ausencia de coeficientes propios (\S\ref{sec:biooptico}).
...
recirculating aquaculture systems (RAS)}. (Soporte cualitativo; sin coeficientes
universales transferibles.)


\bibitem{morris1991} Morris, M.D. (1991). Factorial sampling plans for preliminary
computational experiments. \emph{Technometrics} 33(2), 161--174.

\bibitem{campolongo2007} Campolongo, F., Cariboni, J. \& Saltelli, A. (2007). An
effective screening design for sensitivity analysis of large models.
\emph{Environmental Modelling \& Software} 22, 1509--1518.

\bibitem{sobol2001} Sobol', I.M. (2001). Global sensitivity indices for nonlinear
mathematical models and their Monte Carlo estimates. \emph{Mathematics and Computers
in Simulation} 55, 271--280.

\bibitem{saltelli2008} Saltelli, A., Ratto, M., Andres, T. et al. (2008).
\emph{Global Sensitivity Analysis: The Primer}. Wiley.

\bibitem{kucherenko2009} Kucherenko, S., Rodriguez-Fernandez, M., Pantelides, C. \&
Shah, N. (2009). Monte Carlo evaluation of derivative-based global sensitivity
measures. \emph{Reliability Engineering \& System Safety} 94, 1135--1148.

\bibitem{kennedy2001} Kennedy, M.C. \& O'Hagan, A. (2001). Bayesian calibration of
computer models. \emph{Journal of the Royal Statistical Society B} 63(3), 425--464.

\bibitem{veach1995} Veach, E. \& Guibas, L.J. (1995). Optimally combining sampling
techniques for Monte Carlo rendering. \emph{Proc. SIGGRAPH '95}, 419--428.

\bibitem{mckay1979} McKay, M.D., Beckman, R.J. \& Conover, W.J. (1979). A comparison
of three methods for selecting values of input variables in the analysis of output
from a computer code. \emph{Technometrics} 21(2), 239--245.

\bibitem{kong1994} Kong, A., Liu, J.S. \& Wong, W.H. (1994). Sequential imputations
and Bayesian missing data problems. \emph{Journal of the American Statistical
Association} 89, 278--288.
